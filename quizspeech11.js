...
function predictWord() {
 ...
 recognizer.listen(({scores}) => {
   ...
   switch(scores[0].word){
    ...
    speak("you are right , moving to next question,Person who completes all five management functions on a regular basis and has authority over other jobs and people option one manager , option two supervisor ,option three employee , option four worker, say the correct option ");
                window.location.href = "quiznew12.html";
                clickCounter();
                  break;
    case "two" : 
    window.speechSynthesis.cancel();
    speak("you are wrong , correct answer is option one administrative management,moving to next question, Person who completes all five management functions on a regular basis and has authority over other jobs and people option one manager , option two supervisor ,option three employee , option four worker,  say the correct option ");
