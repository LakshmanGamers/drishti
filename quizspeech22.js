...
function predictWord() {
 ...
 recognizer.listen(({scores}) => {
   ...
   switch(scores[0].word){
    ...
    speak("you are right , moving to next question,All India Kisan Sabha was established in the year option one 1930, option two 1933 ,option three 1936, option four 1940, say the correct option ");
                window.location.href = "quiznew23.html";
                clickCounter();
                  break;
    case "two" : 
    window.speechSynthesis.cancel();
    speak("you are wrong ,correct answer is option one Lord Cornwallis, moving to next question, All India Kisan Sabha was established in the year option one 1930, option two 1933 ,option three 1936, option four 1940,  say the correct option ");
    ...
    case "three" : 
    window.speechSynthesis.cancel();
    speak("you are wrong , correct answer is option two Jawaharlal Nehru,moving to next question, All India Kisan Sabha was established in the year option one 1930, option two 1933 ,option three 1936, option four 1940,  say the correct option ");
