...
function predictWord() {
 ...
 recognizer.listen(({scores}) => {
   ...
   switch(scores[0].word){
    ...
    speak("you are wrong ,correct answer is option four worker, moving to next question,Executives are likely to spend most of their time option one controlling , option two staffing ,option three organizing, option four planning, say the correct option ");
                window.location.href = "quiznew13.html";
                  break;
    case "two" : 
    window.speechSynthesis.cancel();
    speak("you are wrong , correct answer is option four worker, moving to next question,Executives are likely to spend most of their time option one controlling , option two staffing ,option three organizing, option four planning, say the correct option ");
    ...
    case "four" : 
    window.speechSynthesis.cancel();
    speak("you are right , moving to next question,Executives are likely to spend most of their time option one controlling , option two staffing ,option three organizing, option four planning, say the correct option ");
    window.location.href = "quiznew13.html";
    clickCounter();
                   break;
   //case "left" : 
